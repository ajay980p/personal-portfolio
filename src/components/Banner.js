...
export default function Banner() {
    ...
    useEffect(() => {
        const fullText1 = "MERN Stack Developer";
            ...
            <div className="row">
                ...
                <div className="col-md-12 px-5">
                    <div className="social-icons col-md-3 d-flex justify-content-around py-3 mx-5" style={{ backgroundColor: 'var(--color-1)', borderRadius: '10px', padding: '15px!important' }}>
                        <a className='m-3 mx-1' target="blank" rel="noopener noreferrer" href="https://github.com/ajay980p">
                        ...
                        <a className='m-3 mx-1' target="blank" rel="noopener noreferrer" href="https://www.instagram.com/ajay980p">
                        ...
                        <a className='m-3 mx-1' target="blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/ajay980p/">
